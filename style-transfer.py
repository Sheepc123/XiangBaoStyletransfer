...
# 加载图片
content_img = load_img("D:\project\XBstyle-transfer\Style-transfer\datebase\step_14900.png")
style_img = load_img("D:\project\XBstyle-transfer\Style-transfer\datebase\style_img.jpg")
...
for step in range(total_step):
    ...
    if step % 100 == 0:  # Save every 100 steps
        ...
        save_image(img, os.path.join("D:/project/XBstyle-transfer/Style-transfer/output1", f'step_{step}.png'))
